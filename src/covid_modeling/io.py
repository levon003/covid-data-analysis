...
class DataLoader:
    ...
    def _compute_covid_hospitalizations_dataframe(self):
        ...
        covid_patients = self.edf.PATIENT[(self.edf.REASONCODE == covid_code)&(self.edf.ENCOUNTERCLASS == 'inpatient')]
        sdf = self.edf[(self.edf.PATIENT.isin(covid_patients))&(self.edf.STARTDATE > datetime.strptime("2020-01-01", "%Y-%m-%d"))]
